...
* **`webapp`**: interfaz pública construida con React y TypeScript. Está organizada como una aplicación multipágina con entradas separadas para inicio, login, gamemode, registro y juego, lo que hace que cada flujo tenga su propio arranque y su propio contexto visual.
